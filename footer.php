			...
			<!-- start footer Area -->		
			<footer class="footer-area section-gap" style="background-color:grey">
				<div class="container">

					<div class="row">
					
					<div class="row footer-bottom d-flex justify-content-between align-items-center">
						<p class="col-lg-8 col-sm-12 footer-text m-0" style="color:aliceblue">
						ITERA &copy;<script>document.write(new Date().getFullYear());</script>  Sistem Informasi Geografis </i> by Helena Yuniar Simarmata</a>
</p>
